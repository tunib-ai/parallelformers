...
pf = torch.load(os.path.join(args.path, "output-encoder-pf-fp32.pt"))
non_pf = torch.load(os.path.join(args.path, "output-encoder-non-pf-fp32.pt"))
...
print()
pf = torch.load(os.path.join(args.path, "output-decoder-pf-fp32.pt"))
non_pf = torch.load(os.path.join(args.path, "output-decoder-non-pf-fp32.pt"))
# pf means 'parallelformers'
