...
class TestModelForPreTraining(unittest.TestCase):
    @torch.no_grad()
    def test_forward(self, model, tokens):
        output = model(**tokens).hidden_states
...
if __name__ == "__main__":
    ...
    model = AutoModelForPreTraining.from_pretrained(args.name).eval()
