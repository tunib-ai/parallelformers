...
class AutoPolicy:
    ...
    def __init__(self):
        ...
        with suppress(Exception):
            from transformers.models.blenderbot.modeling_blenderbot import BlenderbotPreTrainedModel
            from parallelformers.policies.blenderbot import BlenderbotEncoderPolicy, BlenderbotDecoderPolicy
        ...
        with suppress(Exception):
            from transformers.models.transfo_xl.modeling_transfo_xl import TransfoXLPreTrainedModel
        ...
        with suppress(Exception):
            from transformers.models.blenderbot_small.modeling_blenderbot_small import BlenderbotSmallPreTrainedModel
            from parallelformers.policies.blenderbot_small import BlenderbotSmallEncoderPolicy, BlenderbotSmallDecoderPolicy
            self.builtin_policies[BlenderbotSmallPreTrainedModel] = [
                BlenderbotSmallEncoderPolicy, BlenderbotSmallDecoderPolicy
            ]
        ...
        with suppress(Exception):
            from transformers.models.bert_generation.modeling_bert_generation import BertGenerationPreTrainedModel
            from parallelformers.policies.bert import BertPolicy
        ...
        with suppress(Exception):
            from transformers.models.big_bird.modeling_big_bird import BigBirdPreTrainedModel
        ...
        with suppress(Exception):
            from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus import BigBirdPegasusPreTrainedModel
            from parallelformers.policies.bigbird_pegasus import BigBirdPegasusEncoderPolicy, BigBirdPegasusDecoderPolicy
        ...
        with suppress(Exception):
            ...
            from parallelformers.policies.mbart import MBartEncoderPolicy, MBartDecoderPolicy
        ...
        with suppress(Exception):
            ...
            from parallelformers.policies.pegasus import PegasusEncoderPolicy, PegasusDecoderPolicy
        ...
        with suppress(Exception):
            ...
            from parallelformers.policies.fsmt import FSMTEncoderPolicy, FSMTDecoderPolicy
        ...
        with suppress(Exception):
            ...
            from parallelformers.policies.marian import MarianEncoderPolicy, MarianDecoderPolicy
        ...
        with suppress(Exception):
            from transformers.models.mobilebert.modeling_mobilebert import MobileBertPreTrainedModel
        ...
        with suppress(Exception):
            from transformers.models.dpr.modeling_dpr import DPRPretrainedReader, DPRPretrainedQuestionEncoder, DPRPretrainedContextEncoder
        ...
        with suppress(Exception):
            from transformers.models.retribert.modeling_retribert import RetriBertPreTrainedModel
        ...
        with suppress(Exception):
            ...
            from parallelformers.policies.clip import CLIPTextPolicy, CLIPVisionPolicy, CLIPLayerPolicy
        ...
        with suppress(Exception):
            ...
            from parallelformers.policies.detr import DetrEncoderPolicy, DetrDecoderPolicy
        ...
        with suppress(Exception):
            from transformers.models.reformer.modeling_reformer import ReformerPreTrainedModel
        ...
        with suppress(Exception):
            from transformers.models.roformer.modeling_roformer import RoFormerPreTrainedModel
        ...
        with suppress(Exception):
            from transformers.models.layoutlm.modeling_layoutlm import LayoutLMPreTrainedModel
        ...
        with suppress(Exception):
            ...
            from parallelformers.policies.led import LEDEncoderPolicy, LEDDecoderPolicy
        ...
        with suppress(Exception):
            from transformers.models.prophetnet.modeling_prophetnet import ProphetNetPreTrainedModel
            from parallelformers.policies.prophetnet import ProphetNetEncoderPolicy, ProphetNetDecoderPolicy
        ...
        with suppress(Exception):
            from transformers.models.speech_to_text.modeling_speech_to_text import Speech2TextPreTrainedModel
            from parallelformers.policies.speech_to_text import Speech2TextEncoderPolicy, Speech2TextDecoderPolicy
