...
class DebertaV2Policy(Policy):
    ...
    def attn_qkv():
        return [
            Layer(
                weight="attention.self.query_proj.weight",
                bias="attention.self.query_proj.bias",
            ),
            Layer(
                weight="attention.self.key_proj.weight",
                bias="attention.self.key_proj.bias",
            ),
            Layer(
                weight="attention.self.value_proj.weight",
                bias="attention.self.value_proj.bias",
            ),
        ]
