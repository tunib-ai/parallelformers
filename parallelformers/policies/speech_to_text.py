...
class Speech2TextEncoderPolicy(Policy):
    @staticmethod
    ...
    def replace_modules():
        return {
            "Speech2TextAttention": BartAttention_,
        }
    ...
    def original_layer_class():
        return Speech2TextEncoderLayer


class Speech2TextDecoderPolicy(Policy):
    @staticmethod
    def replace_arguments(config, world_size):
        return {
            # 1. reduce hidden size
    ...
    @staticmethod
    def original_layer_class():
        return Speech2TextDecoderLayer
