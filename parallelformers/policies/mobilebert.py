...
from transformers.models.mobilebert.modeling_mobilebert import MobileBertLayer

from parallelformers.policies.base import Layer, Policy
from parallelformers.utils import AllReduceLinear


class MobileBertPolicy(Policy):
    @staticmethod
    def replace_arguments(config, world_size):
        return {
            # 1. reduce hidden size
            "attention.self.all_head_size": config.intra_bottleneck_size // world_size,
