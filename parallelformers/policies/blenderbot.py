...
class BlenderbotEncoderPolicy(Policy):
    @staticmethod
    ...
    def replace_modules():
        return {
            "BlenderbotAttention": BartAttention_,
        }
    ...
    def original_layer_class():
        return BlenderbotEncoderLayer


class BlenderbotDecoderPolicy(Policy):
    @staticmethod
    def replace_arguments(config, world_size):
        return {
            # 1. reduce hidden size
